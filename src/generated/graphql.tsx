...
export type LaunchListQuery = { __typename?: 'Query' } & {
  launches: Maybe<
    Array<
      Maybe<
        { __typename?: 'Launch' } & Pick<Launch, 'flight_number' | 'mission_name' | 'launch_year'>
      >
    >
  >
}
...
export type LaunchProfileQuery = { __typename?: 'Query' } & {
  launch: Maybe<
    ...
    > & {
        ...
        rocket: Maybe<
          { __typename?: 'LaunchRocket' } & Pick<LaunchRocket, 'rocket_name' | 'rocket_type'>
        >
...
export type LaunchListComponentProps = Omit<
  ApolloReactComponents.QueryComponentOptions<LaunchListQuery, LaunchListQueryVariables>,
  'query'
>
...
export type LaunchListProps<TChildProps = {}> =
  | ApolloReactHoc.DataProps<LaunchListQuery, LaunchListQueryVariables>
  | TChildProps
...
export function useLaunchListQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<LaunchListQuery, LaunchListQueryVariables>
) {
...
export function useLaunchListLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<LaunchListQuery, LaunchListQueryVariables>
) {
  return ApolloReactHooks.useLazyQuery<LaunchListQuery, LaunchListQueryVariables>(
    LaunchListDocument,
    baseOptions
  )
}
...
export type LaunchProfileComponentProps = Omit<
  ApolloReactComponents.QueryComponentOptions<LaunchProfileQuery, LaunchProfileQueryVariables>,
  'query'
> &
  ({ variables: LaunchProfileQueryVariables; skip?: boolean } | { skip: boolean })
...
export type LaunchProfileProps<TChildProps = {}> =
  | ApolloReactHoc.DataProps<LaunchProfileQuery, LaunchProfileQueryVariables>
  | TChildProps
...
export function useLaunchProfileQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<LaunchProfileQuery, LaunchProfileQueryVariables>
) {
  return ApolloReactHooks.useQuery<LaunchProfileQuery, LaunchProfileQueryVariables>(
    LaunchProfileDocument,
    baseOptions
  )
}
export function useLaunchProfileLazyQuery(
  ...
  return ApolloReactHooks.useLazyQuery<LaunchProfileQuery, LaunchProfileQueryVariables>(
    LaunchProfileDocument,
    baseOptions
  )
}
